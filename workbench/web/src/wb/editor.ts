  ...
  const state = EditorState.create({
    ...
    extensions: [
      ...
      EditorView.theme({
        ...
        ".cm-content": { caretColor: "#F7A21E" },
        ".cm-cursor, .cm-dropCursor": { borderLeftColor: "#F7A21E" },
        ".cm-activeLine": { backgroundColor: "rgba(247, 162, 30, 0.06)" },
        ".cm-activeLineGutter": { backgroundColor: "rgba(247, 162, 30, 0.06)" },
      }),
    ],
  });
